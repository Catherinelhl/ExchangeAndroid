 ...
 * @since 2019/1/4
 * 自定义视图：侧滑界面，显示当前可以用于自选的币种信息
 */
public class ChooseCurrenciesPop extends PopupWindow {
    private String TAG = ChooseCurrenciesPop.class.getSimpleName();
    GridView gvMethods;
    TextView tvReset;
    TextView tvSure;
    ...
    public ChooseCurrenciesPop(Context context) {
    ...
    private void initView() {
        view = LayoutInflater.from(context).inflate(R.layout.pop_choose_currencies, null);
        // 把View添加到PopWindow中
