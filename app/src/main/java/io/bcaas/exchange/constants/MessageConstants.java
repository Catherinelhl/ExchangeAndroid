...
public class MessageConstants {
    ...
    public static final String ERROR_SEND_PHONE_MESSAGE_FAIL = "Send phone message fail.";
    ...
    public static final String ERROR_SEND_MAIL_VERIFY_CODE = "Send mail verify code fail.";
    ...
    public static final int CODE_2043 = 2043;
    public static final String ERROR_ACCESSTOKEN_FORMAT_INVALID = "AccessToken format invalid.";
    public static final int CODE_2044 = 2044;
    public static final String ERROR_VERIFY_TYPE_FORMAT = "Verify type format error.";
    ...
    public static final String ERROR_VERIFY_PHONE_CODE__FAIL = "Verify phone code fail.";
    ...
    public static final String ERROR_MEMBER_BALANCEAVAILABLE_LESS_THAN_EQUAL_TO_AMOUNT = "Member balanceAvailable less than equal to amount.";
    public static final int CODE_2059 = 2059;
    public static final String ERROR_MEMBER_BALANCEAVAILABLE_AND_AMOUNT_COMPARE_FAILURE = "Member balanceAvailable and amount compare failure.";
    ...
    public static final int CODE_2063 = 2063;
    public static final String ERROR_WITHDRAW_MARK_FORMAT_INVALID = "Withdraw mark format invalid.";
    public static final int CODE_2064 = 2064;
    public static final String ERROR_WITHDRAW_GET_CONFIG_ADDRESS = "Withdraw get config address failure.";
    public static final int CODE_2065 = 2065;
    public static final String ERROR_WITHDRAW_GET_CONFIG_PRIVATEKEY = "Withdraw get config privateKey failure.";
    public static final int CODE_2066 = 2066;
    public static final String ERROR_INSUFFICIENT_BALANCES = "Insufficient balances.";
    public static final int CODE_2067 = 2067;
   ...
   public static final int CODE_2077 = 2077;
    ...
    public static final int CODE_2079 = 2079;
    public static final String ERROR_ENDTIME_FORMAT = "EndTime foramt error.";
