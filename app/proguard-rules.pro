...
#qrcode
-dontwarn com.obt.qrcode.activity.CaptureActivity
-dontnote com.obt.qrcode.activity.CaptureActivity
...
#
-dontwarn io.bcaas.exchange.bean.**
#对含有反射类的处理
-keep class io.bcaas.exchange.bean.** { *; }
